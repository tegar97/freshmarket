...
import '../modal_buttom/modal_buttom_sheet.dart';
...
class PickerImage {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            pickWidget(
               iconPath:Icon(Icons.browse_gallery, color: Colors.white, size: 30),
                title: "Galeri",
                onClick: () async {
  ...
  static Widget pickWidget({required  Icon iconPath, required String title, required Function onClick}) {
    return Column(
      children: [
        Container(
            width: 100,
